...
def make_csv(prompts, harassment_scores, harassment_threatening_scores, hate_scores,  hate_threatening_scores, self_harm_scores, self_harm_instructions_scores, self_harm_intent_scores, sexual_scores, sexual_minors_scores, violence_scores, violence_graphic_scores):
  with open('openai-moderation-data.csv', 'w', newline='') as file:
...
prompts, harassment_scores, harassment_threatening_scores, hate_scores,  hate_threatening_scores, self_harm_scores, self_harm_instructions_scores, self_harm_intent_scores, sexual_scores, sexual_minors_scores, violence_scores, violence_graphic_scores = all_responses('../prompts.txt')
